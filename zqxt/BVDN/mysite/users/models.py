...
class User(AbstractUser):
    ...
    zhengzhi_mianmao = models.CharField(max_length=10, default='people')
    zhengzhi_time = models.CharField(max_length=20, default='2010-10-31')

    job = models.CharField(max_length=30, default='engineer')
    job_time = models.CharField(max_length=20, default='2010-10-31')

    job_2 = models.CharField(max_length=30, default='engineer')
    id_number = models.CharField(max_length=30, default='6545641315151561561561')

    xue_li = models.CharField(max_length=30, default='本科')
    school = models.CharField(max_length=30, default='北京大学')
    graduate_time = models.CharField(max_length=20, default='2010-10-31')
    job_join_time = models.CharField(max_length=20, default='2010-10-31')
    team_belong = models.CharField(max_length=20, default='C640')

    phone = models.CharField(max_length=30, default='19912341234')
